        ...
        <div className='mx-auto max-w-screen-xl space-y-8 px-4 py-16 sm:px-6 lg:space-y-16 lg:px-8'>
          ...
          <div className='grid gap-6 grid-cols-5 md:pt-20'>
            <div className='md:block hidden'>
              ...
              <p className='max-w-xs text-[#7b858b] font-sans '>
                Delivering Quality Software and Service
              </p>
              <p className='text-xs text-[#7b858b] font-sans mt-2'>
              ...
              <div className='w-1/3 sm:w-auto sm:mx-4 mb-10 sm:mb-0'>
                ...
                >
                  <svg
                    ...
                    strokeWidth='0'
                    viewBox='0 0 496 512'
                    className='w-8 h-8 text-gray-300 transition-colors duration-300 group-hover:text-brand-light'
                    height='1em'
                    width='1em'
                  ...
                  <h5 className='font-recoleta mt-1 lg:mt-3 xl:mt-5 text-sm sm:text-base font-sans text-gray-200 transition-colors duration-300 group-hover:text-brand-light'>
                    GitHub
                  </h5>
                </a>
              </div>
