  ...
  return (
    <>
      <div
        ...
        className=' bg-gradient-to-b from-brand-light to-light-bg pt-[160px] md:pt-[260px] pb-[100px] lg:pb-[600px] relative lg:h-[800px]'
      >
        <div className='container m-auto'>
          ...
          <h1 className='relative font-recoletaBlack text-3xl lg:text-5xl text-brand-light mb-5 md:px-24 px-5'>
            About My Self
          </h1>
